...
if __name__ == '__main__':
    ...
    os.environ["DEBUG"] = "1"
    bitis_gunu = datetime.strptime('2023-01-13 18:30:00', '%Y-%m-%d %H:%M:%S').replace(tzinfo=timezone.utc)
    # bitis_gunu = datetime.strptime('2022-12-28 15:00:00', '%Y-%m-%d %H:%M:%S').replace(tzinfo=timezone.utc)
    # _son = datetime.strptime('2022-08-01 00:00:00', '%Y-%m-%d %H:%M:%S').replace(tzinfo=timezone.utc)
    _son = datetime.strptime('2023-01-14 08:00:00', '%Y-%m-%d %H:%M:%S').replace(tzinfo=timezone.utc)
