...
window_end = datetime.strptime('2019-12-20 00:00:00', '%Y-%m-%d %H:%M:%S').replace(tzinfo=timezone.utc)
start = datetime.strptime('2020-03-01 00:00:00', '%Y-%m-%d %H:%M:%S').replace(tzinfo=timezone.utc)
