...
window_end = datetime.strptime('2023-04-01 00:00:00', '%Y-%m-%d %H:%M:%S').replace(tzinfo=timezone.utc)
start = datetime.strptime('2023-04-30 00:00:00', '%Y-%m-%d %H:%M:%S').replace(tzinfo=timezone.utc)
