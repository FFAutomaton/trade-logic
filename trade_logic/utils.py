...
def sonuc_yazdir(start_date, end_date, small, big, mel, em_w, r, e, c, mom, rb, eb, me, tr, dk, trader, islem_sonuc):
    ...
    print(f"{c}-{start_date}-{end_date}-[({small},{big})-{mel}]-{em_w}-{r}-{e}-{mom}-{rb}-{eb}--{me}--{tr}--{dk}:\t{kar}")
